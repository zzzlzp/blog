...
<nav class="navbar navbar-default navbar-static-top">
	<div class="container" style="padding-top: 5px">
		<ul class="nav nav-pills">
			...
			<li role="presentation">
				<a href="<?php echo U('/Home/Index/article_show');?>">文章</a>
			</li>
			<li role="presentation">
...
<div class="panel panel-default">
	...
	<form name="article" action="<?php echo U('/Home/Article/add');?>" method="post">
		<table class="table">
			<tr>
				<td>标题:</td>
				<td>
		...
		<div class="panel-footer">
			...
			<a href="<?php echo U('/Home/Index/article_show');?>" class="btn btn-info">返回</a>
		</div>
	</form>
</div>